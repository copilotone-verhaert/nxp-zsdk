...
/* Entropy */
	...
	(defined(ELS)) || (defined(FSL_FEATURE_ELE_S4XX) && (FSL_FEATURE_ELE_S4XX > 0)) ||         \
 ...
 */
	...
	(defined(FSL_FEATURE_ELEMU_HAS_SEMA4_STATUS_REGISTER) &&                                   \
	 (FSL_FEATURE_ELEMU_HAS_SEMA4_STATUS_REGISTER > 0)) &&                                     \
