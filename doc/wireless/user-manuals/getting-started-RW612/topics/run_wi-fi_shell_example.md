...
Ensure that the Wi-Fi shell example is flashed onto the RW612 BGA board. Refer to [Build and flash examples](build_and_flash_examples.md).

This section describes how to configure the access point \(AP mode\) and the connection with external access point \(STA mode\).
