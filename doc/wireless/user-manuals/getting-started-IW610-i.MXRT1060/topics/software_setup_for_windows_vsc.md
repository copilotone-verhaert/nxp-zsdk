[Index page](../getting-started-iw610-imxrt1060.md) \| [Software setup](software_setup.md)
...
Open the **Extensions** tab on the left panel of the VS Code, look for **MCUXpresso for VS Code** in the search bar and install the extension.
