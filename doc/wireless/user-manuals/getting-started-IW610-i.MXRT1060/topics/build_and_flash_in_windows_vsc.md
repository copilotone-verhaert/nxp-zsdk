[Index page](../getting-started-iw610-imxrt1060.md) \| [Build and flash examples](build_and_flash_examples.md)
...
Open the **Import Example from the Repository** dialog window, and fill the fields as described. Then, click the **Import** button.

![](../images/import-wifi-shell-from-repository.png)

Step 2 - Build configurations of IW610\_MURATA-2LL-M2.

Click the **Edit** button of the **Build Configurations**. Add below settings in the **CMake Extra Args** field of the dialog window.

```
SHIELD='nxp_m2_2ll_wifi_bt' EXTRA_CONF_FILE='nxp/overlay_iw610.conf nxp/overlay_hostap_hosted_mcu.conf'
```
...
Right-click the imported project and select **Flash the Selected Target** to flash the Wi-Fi shell application to the MIMXRT1060 board.
...
```
SHIELD='nxp_m2_2ll_wifi_bt' EXTRA_CONF_FILE='overlay-wifi-nxp-iw610.conf overlay-wifi-nxp-hostap-hosted-mcu.conf'
```
