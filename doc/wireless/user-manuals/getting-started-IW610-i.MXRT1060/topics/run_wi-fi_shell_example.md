...
Ensure the Wi-Fi shell example is flashed onto the IW610 module and i.MX RT1060 EVKC board. Refer to [Build and flash examples](build_and_flash_examples.md).
