...
The following image illustrates the hardware connection required for the setup. Murata 1XK M.2 module can be connected to i.MX RT1060 EVKC directly through the M.2 slot.
