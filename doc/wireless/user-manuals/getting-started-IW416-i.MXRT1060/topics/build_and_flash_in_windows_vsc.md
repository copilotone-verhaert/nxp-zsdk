[Index page](../getting-started-iw416-imxrt1060.md) \| [Build and flash examples](build_and_flash_examples.md)
...
Step 2 - Build configurations of IW416\_MURATA-1XK-M2.

Click the **Edit** button of the **Build Configurations**. Add below settings in the **CMake Extra Args** field of the dialog window.

```
SHIELD='nxp_m2_1xk_wifi_bt' EXTRA_CONF_FILE='nxp/overlay_hosted_mcu.conf;nxp/overlay_debug.conf;nxp/overlay_hostap_hosted_mcu.conf'
```
...
Add below settings in the **CMake Extra Args** field of the dialog window.
...
```
SHIELD='nxp_m2_1xk_wifi_bt' EXTRA_CONF_FILE='overlay-wifi-nxp-hosted-mcu.conf'
```
